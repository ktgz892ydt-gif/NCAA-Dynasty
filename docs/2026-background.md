> Historical 2026 documentation, retained for its statistical background. For current file paths and commands, use [the main README](../README.md) and [migration report](migration-report.md).
...
possession; their provenance and remaining gaps are recorded in [source notes](../data/seasons/2026/source-notes.md).
...
Their full raw transcriptions are not included in the repository. See [source notes](../data/seasons/2026/source-notes.md)
